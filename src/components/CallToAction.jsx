          ...
          <div className="mt-10 mx-auto max-w-lg rounded-2xl bg-white/10 p-6 backdrop-blur-sm">
            ...
            <div className="space-y-2 text-left text-white/90">
              <div className="flex justify-between">
                <span>Junior SDR (all-in cost):</span>
                <span className="font-semibold">$85,000+/year</span>
              </div>
              <div className="flex justify-between">
                <span>Our service:</span>
                <span className="font-semibold">$60,000/year</span>
              </div>
              <div className="flex justify-between border-t border-white/20 pt-2 mt-2">
                <span>You save:</span>
                <span className="font-semibold text-green-300">$25,000+/year</span>
              </div>
            </div>
            <p className="mt-4 text-sm text-white/80 text-left">
              Plus: No recruiting fees. No training time. No turnover headaches.
            </p>
          </div>
